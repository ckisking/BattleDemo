	...
	*/
	...
	export enum BlendFactor {		
		...
		*/
		...
		构造函数，可查看 {{#crossLink "cc/vec2:method"}}cc.v2{{/crossLink}} 或者 {{#crossLink "cc/p:method"}}cc.p{{/crossLink}} 
		*/
		getTouchByXY(tx : number, ty : number, pos: (x: number, y: number) => void) : Touch;		
		/** 
		@param location !#en
		Constructor
		see {{#crossLink "cc/vec2:method"}}cc.v2{{/crossLink}} or {{#crossLink "cc/p:method"}}cc.p{{/crossLink}}
		...
		构造函数，可查看 {{#crossLink "cc/vec2:method"}}cc.v2{{/crossLink}} 或者 {{#crossLink "cc/p:method"}}cc.p{{/crossLink}} 
		*/
		getTouchByXY(location: (x: number, y: number) => void, pos: (x: number, y: number) => void, eventType : number) : Event.EventMouse;		
		/** 
		@param pos !#en
		Constructor
		see {{#crossLink "cc/vec2:method"}}cc.v2{{/crossLink}} or {{#crossLink "cc/p:method"}}cc.p{{/crossLink}}
		...
		构造函数，可查看 {{#crossLink "cc/vec2:method"}}cc.v2{{/crossLink}} 或者 {{#crossLink "cc/p:method"}}cc.p{{/crossLink}} 
		*/
		getPointByEvent(event : Touch, pos: (x: number, y: number) => void) : Vec2;		
		/** 
		@param pos !#en
		Constructor
		see {{#crossLink "cc/vec2:method"}}cc.v2{{/crossLink}} or {{#crossLink "cc/p:method"}}cc.p{{/crossLink}}
		...
		构造函数，可查看 {{#crossLink "cc/vec2:method"}}cc.v2{{/crossLink}} 或者 {{#crossLink "cc/p:method"}}cc.p{{/crossLink}} 
		*/
		getTouchesByEvent(event : Touch, pos: (x: number, y: number) => void) : any[];		
		/**  
		*/
	...
	export enum Macro {		
		...
		*/
		apply(view : View, designedResolution: (width: number, height: number) => void) : void;		
		...
		*/
		apply(view : View, designedResolution: (width: number, height: number) => void) : any;		
		/** Manipulation after applying the strategy
		@param view The target view 
		*/
		postApply(view : View) : void;	
		...
		*/
		...
		/** initialize
		@param visibleRect !#en
		Constructor of cc.Rect class.
		see {{#crossLink "cc/rect:method"}} cc.rect {{/crossLink}} for convenience method.
		!#zh
		cc.Rect类的构造函数。可以通过 {{#crossLink "cc/rect:method"}} cc.rect {{/crossLink}} 简便方法进行创建。 
		*/
		init(visibleRect: (x: number, y: number, w: number, h: number) => void) : void;		
